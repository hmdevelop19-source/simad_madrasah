...
<div style="text-align:center;padding:1rem 0;">
    ...
    <h1 style="font-size:1.5rem;font-weight:700;color:#1E293B;margin-bottom:.5rem;">Akses Ditolak</h1>
    ...
    <p style="margin-top:1.5rem;font-size:.775rem;color:#94A3B8;">Error Code: 403 Forbidden</p>
</div>
@endsection
